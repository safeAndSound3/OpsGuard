...
function hadoopContainerLabel(container: { id: string; priority?: string }, applicationType?: string) {
  ...
  return String(container.priority) === '0' ? `主容器 · ${sequence}` : `工作容器 · ${sequence}`
}
